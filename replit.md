...
- **Source Type Cleanup (Latest)**: Simplified librarySource from 5 legacy values to 3 clean values: 'internal', 'industry_standard', 'ai_inventory'. Migrated 48 database records from 'rsa_internal' to 'internal'. Updated all UI components with legacy fallback support for smooth transition.
