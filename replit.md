...
- **Questionnaire Restoration (Latest)**: Restored "Current AI & Data Capabilities" questionnaire with 200+ elements across 6 pages from git history. Admin Assessment tab now shows both questionnaires with full statistics.
