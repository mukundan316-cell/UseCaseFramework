...
export class PDFExportService {
  ...
  static createDocument(options: ExportOptions): any {
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Subject: 'Hexaware AI Use Case Value Framework',
        Keywords: 'Hexaware, AI, Assessment, Use Cases',
        Creator: 'Hexaware AI Framework',
        Producer: 'Hexaware',
      },
    });
  ...
  static addHeader(doc: any, title: string, pageNumber: number): void {
    const { primaryColor } = this.COMPANY_BRANDING;
  ...
  static addFooter(doc: any): void {
    ...
    doc.fontSize(8)
       ...
       .text('Hexaware AI Use Case Value Framework - Confidential', 20, footerY + 20)
       .text(format(new Date(), 'PPP'), 20, footerY + 35)
       .text('Generated by Hexaware Digital Innovation', doc.page.width - 200, footerY + 20, { align: 'right' });
  }

  /**
   * Add section header with company styling
   */
  ...
  /**
   * Add data table with company styling
   */
