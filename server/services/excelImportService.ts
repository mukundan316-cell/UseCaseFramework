...
export class ExcelImportService {
   ...
   * Only title and description are required, meaningfulId will be auto-generated based on librarySource
   */
  private static minimalValidationSchema = z.object({
    ...
    // meaningfulId is not included here as it will be auto-generated by storage layer
