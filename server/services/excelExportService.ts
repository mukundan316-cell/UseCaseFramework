  ...
  private static createStrategicUseCasesSheet(useCases: any[]): XLSX.WorkSheet {
    ...
    const rows = useCases.map(rawUseCase => {
      ...
      return [
        ...
        useCase.aiInventory.explainabilityRequired !== null && useCase.aiInventory.explainabilityRequired !== undefined ? (useCase.aiInventory.explainabilityRequired ? 'Yes' : 'No') : '',
        useCase.aiInventory.customerHarmRisk || '',
        useCase.aiInventory.dataOutsideUkEu !== null && useCase.aiInventory.dataOutsideUkEu !== undefined ? (useCase.aiInventory.dataOutsideUkEu ? 'Yes' : 'No') : '',
        useCase.aiInventory.thirdPartyModel !== null && useCase.aiInventory.thirdPartyModel !== undefined ? (useCase.aiInventory.thirdPartyModel ? 'Yes' : 'No') : '',
        useCase.aiInventory.humanAccountability !== null && useCase.aiInventory.humanAccountability !== undefined ? (useCase.aiInventory.humanAccountability ? 'Yes' : 'No') : '',
