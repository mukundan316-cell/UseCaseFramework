  ...
  private static createStrategicUseCasesSheet(useCases: any[]): XLSX.WorkSheet {
    ...
    const rows = useCases.map(rawUseCase => {
      ...
      return [
        ...
        (useCase.aiInventory as any).explainabilityRequired !== null && (useCase.aiInventory as any).explainabilityRequired !== undefined ? ((useCase.aiInventory as any).explainabilityRequired ? 'Yes' : 'No') : '',
        (useCase.aiInventory as any).customerHarmRisk || '',
        (useCase.aiInventory as any).dataOutsideUkEu !== null && (useCase.aiInventory as any).dataOutsideUkEu !== undefined ? ((useCase.aiInventory as any).dataOutsideUkEu ? 'Yes' : 'No') : '',
        (useCase.aiInventory as any).thirdPartyModel !== null && (useCase.aiInventory as any).thirdPartyModel !== undefined ? ((useCase.aiInventory as any).thirdPartyModel ? 'Yes' : 'No') : '',
        (useCase.aiInventory as any).humanAccountability !== null && (useCase.aiInventory as any).humanAccountability !== undefined ? ((useCase.aiInventory as any).humanAccountability ? 'Yes' : 'No') : '',
        (useCase.aiInventory as any).regulatoryCompliance || '',
