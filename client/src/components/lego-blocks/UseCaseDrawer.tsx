...
import { X, Edit, FileText, Building2, Users, ExternalLink, Target, AlertTriangle } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {(useCase.librarySource === 'rsa_internal' || useCase.librarySource === 'hexaware_external') ? (
            <Accordion type="multiple" defaultValue={["overview", "strategic-scoring"]} className="w-full">
              ...
              <AccordionItem value="strategic-scoring">
                <AccordionTrigger className="text-lg font-semibold">
                  Strategic Scoring
                </AccordionTrigger>
                <AccordionContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {useCase.linesOfBusiness?.length > 0 ? 
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {useCase.businessSegments?.length > 0 ?
