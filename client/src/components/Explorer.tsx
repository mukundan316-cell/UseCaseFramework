        ...
        <Tabs defaultValue="active" className="space-y-6">
          ...
          <TabsContent value="active" className="space-y-6">
            <ImprovedUseCaseExplorer
              ...
              description="Use cases selected for implementation with completed scoring and prioritization"
              ...
              emptyStateMessage="No use cases in Active Portfolio. Add use cases from the Reference Library to get started."
              context="active"
            />
          </TabsContent>
