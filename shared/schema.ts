...
export const insertQuestionSchema = createInsertSchema(questions).omit({
  ...
  questionType: z.enum(['text', 'number', 'select', 'multiselect', 'scale', 'boolean', 'smart_rating', 'ranking', 'currency', 'percentage_allocation', 'business_lines_matrix', 'department_skills_matrix', 'company_profile', 'business_performance', 'multi_rating', 'textarea']),
